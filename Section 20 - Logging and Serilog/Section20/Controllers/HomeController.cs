...
using Section20.Utilities;
using Section20.ViewModels;
using Services.Users.Interface;

namespace Section20.Controllers
{
    public class HomeController : Controller
    {
        public readonly IUsers _users;
        private readonly ILogger<HomeController> _logger;
        public HomeController(IUsers users, ILogger<HomeController> logger) {
            _users = users;
            _logger = logger; 
        }
        ...
        {
            _logger.Log(LogLevel.Information, "Index Reached and Redirected to Search Page");
